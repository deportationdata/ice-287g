...
Rscript code/1-read-agencies.R
Rscript code/1-read-hifld-law-enforcement.R
Rscript code/1-read-jails-prisons-tables.R
Rscript code/1-read-manual-inputs.R
Rscript code/1-read-facility-tables.R
...
# bind the non-facility layers, annotate, format
Rscript code/3-make-non-facility-sf.R
Rscript code/4-merge-agency-oris.R
