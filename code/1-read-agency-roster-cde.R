# FBI Crime Data Explorer agency roster, by state -> data/intermediate/agency-roster-cde-2025.parquet
library(tidyverse)
library(arrow)
library(httr2)
...
crime_cache_path <- "data/intermediate/cache-cde-api.parquet"
...
if (!file.exists(crime_cache_path)) {
  ...
  write_parquet(crime_data, crime_cache_path)
}

crime <- read_parquet(crime_cache_path) |>
  transmute(
...
write_parquet(crime, "data/intermediate/agency-roster-cde-2025.parquet")
