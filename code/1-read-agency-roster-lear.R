# LEAR agency roster (ICPSR 36697) -> data/intermediate/agency-roster-lear-2016.parquet
library(tidyverse)
library(arrow)
library(haven)
...
state_xwalk <- read_parquet("data/intermediate/reference-state-codes.parquet")
...
write_parquet(lear, "data/intermediate/agency-roster-lear-2016.parquet")
